...
export default function Pagination(props) {
    ...
    console.log('la page dans pagination: ', page)
    console.log('dernier: ', last)
    console.log('premier: ', first)
    console.log('la vue dans pagination: ', props.view)
    console.log('test première: ', first)

    useEffect ( () => {
        // change animalPage in CardList component
        console.log('la page envoyée: ', page)
        props.onPage(page)
    }, [page])
